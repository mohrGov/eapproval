...
<table width="999" border="0" align="center" cellpadding="5"  cellspacing="0" style="border-left: 1px solid #a4c8e0; border-right: 1px solid #a4c8e0; border-top: 1px solid #a4c8e0; border-bottom: 1px solid #a4c8e0">
  ...
  <tr>
    <td colspan="5" style="border-bottom: 1px solid #a4c8e0" bgcolor="#CC9966" height="25" align="center"><strong>[ URUSAN RASMI ]</strong></td>
	<td colspan="5" style="border-bottom: 1px solid #a4c8e0" bgcolor="#CC3333" align="center"><strong>[ <a href="inboxperibadi.php">URUSAN PERIBADI</a> ]</strong></td>
  </tr>
  <tr bgcolor="#DF7B7B">
  ...
  <?php
  		$query = "select a.*, b.* from intrayinfo a, intraystatussemasa b, intrayprofile c where a.jenispermohonan = 'F0000002' AND (a.userid = '$userid' or b.waiting_for = '$userid') and a.idinfo = b.idinfo and a.userid = c.userid order by  a.tarikhpermohonan desc";
...
?>
  <tr>
    ...
    <td style="border-left: 1px solid #a4c8e0; border-right: 1px solid #a4c8e0; border-top: 1px solid #a4c8e0; border-bottom: 1px solid #a4c8e0" align="center"><?php echo $mystatusdesc;?></td>
