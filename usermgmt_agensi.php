...
<body>
<form action="usermgmt2_agensi.php" name="formpengguna" method="post">
<!-- table besar --------------------------------------------------------------------------------------------------------------------------->
...
<?php
$query1 = "select a.userid, a.role, b.nama_pgw, b.jabatan, b.jawatan from intrayusers a, intrayprofile b";
//kalau jabatan & role 
if ($offcode && $rolebaru)
{
...
{
	$query1 .= " where a.userid = b.userid and b.jabatan = '$offcode'";
}
else if ($rolebaru)
{
	$query1 .= " where a.userid = b.userid and b.jabatan = '$offcode' and a.role = '$rolebaru'";
