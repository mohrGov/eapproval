...
<form action="prousermgmt.php" method="post" name="mof">
<body>
<!-- table besar --------------------------------------------------------------------------------------------------------------------------->
...
<td><table width="979" border="0" align="center" cellpadding="5"  cellspacing="0" style="border-left: 1px solid #a4c8e0; border-right: 1px solid #a4c8e0; border-top: 1px solid #a4c8e0; border-bottom: 1px solid #a4c8e0">
  ...
  <tr>
    ...
    <td width="5">:</td>
    <td width="717"><?php echo $kn?><input type="hidden" name="myname" value="<?php echo $kn?>" /></td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <?php //jenis permohonan
 	 	$query = mysql_query("select * from intrayrefrole where idrole !='00'");
