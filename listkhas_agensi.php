...
if ($role == '09')
{
$query1 = "select a.*, b.nama_pgw from intrayinfo a, intrayprofile b,  intraytempuserluar c where substr(a.idinfo,1,1) = 'H' and a.userid = b.userid and a.userid=c.userid and upper(a.offcode)='$offcode'";
}
else
{
$query1 = "select a.*, b.nama_pgw from intrayinfo a, intrayprofile b,  intraytempuserluar c where substr(a.idinfo,1,1) = 'K' and a.userid = b.userid and a.userid=c.userid and upper(a.offcode)='$offcode'";
}
