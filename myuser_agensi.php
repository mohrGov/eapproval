...
<form action="usermgmt_agensi.php" method="post" name="mof" id="mof">
<body>
<!-- table besar --------------------------------------------------------------------------------------------------------------------------->
...
<td><table width="979" border="0" align="center" cellpadding="5"  cellspacing="0" style="border-left: 1px solid #a4c8e0; border-right: 1px solid #a4c8e0; border-top: 1px solid #a4c8e0; border-bottom: 1px solid #a4c8e0">
  ...
  <tr>
    ...
    <td width="5">: <input type ="hidden" name="jabatan" value="<?php echo $offcode; ?>" /></td>
    <td width="717"> 
	<?php
	if ($role == '09')
	{
  ...
  <tr>
   ...
   if ($role == '09')
	{
		$query = mysql_query("select * from intrayrefrole where idrole in ('01','00')");
	}
	else
	{
