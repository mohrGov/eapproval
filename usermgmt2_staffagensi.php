...
$query = "select b.flagsah from intrayusers a, intraytempuserluar b where a.userid = '$kn'";
...
<form action="prousermgmt_staffagensi.php" method="post" name="mof" id="mof">
<body>
<!-- table besar --------------------------------------------------------------------------------------------------------------------------->
...
<td><table width="979" border="0" align="center" cellpadding="5"  cellspacing="0" style="border-left: 1px solid #a4c8e0; border-right: 1px solid #a4c8e0; border-top: 1px solid #a4c8e0; border-bottom: 1px solid #a4c8e0">
  ...
  <tr>
    <td width="225" height="45">Status Semasa </td>
    <td width="5">:</td>
    
	<td width="717">Aktif</td>
	
	
  </tr>
  <tr>
    <td width="225" height="45">Tukar Kepada </td>
    <td width="5">:</td>
    <td width="717"><select name="flagbaru" id="flagbaru">
